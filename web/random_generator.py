...
def random_input(isGood):
    ...
    if isGood == True:
        ...
        Directors = pd.read_csv(f"{FILE_DIR}/top_director_list.csv").sample(n = random.randint(2, 4))['Directors'].tolist()
        Writers = pd.read_csv(f"{FILE_DIR}/top_Writers_list.csv").sample(n = random.randint(2, 4))['Writers'].tolist()
        ...
        Directors = pd.read_csv(f"{FILE_DIR}/random_Directors_list.csv").sample(n = random.randint(2, 4))['Directors'].tolist()
        Writers = pd.read_csv(f"{FILE_DIR}/random_Writers_list.csv").sample(n = random.randint(2, 4))['Writers'].tolist()
        num_of_crew = random.randint(1, 9)
